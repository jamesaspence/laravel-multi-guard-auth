                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('host-login') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') ?? 'testHost@jamesspencemilwaukee.com' }}" required autofocus>
